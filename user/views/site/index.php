...
$this->title = 'Организация банкетов | Банкет.Фан';
$this->params['breadcrumbs'][] = $this->title;

$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Профессиональный подбор площадки для организации банкетов. Помощь в поиске лучшего заведения для вашего мероприятия.'
]);
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <?php /*                                        <h4>Рестораны дадут самые выгодные условия и лучшие цены.</h4>
                                        <h2>BANKET FUN</h2>*/ ?>
                    <p>На качественную сторону банкета непосредственное влияние оказывает правильная организация:
                        сервировка по всем правилам, профессиональный обслуживающий персонал, правильно составленное
                        меню, развлекательная программа с учетом характера мероприятия.
                    </p>
                    <p>
                        Наша команда готова оказать помощь в поиске лучшего заведения для вашего мероприятия. Решение о
                        выборе принимаете вы.</p>
