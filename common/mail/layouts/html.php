...
/** @var \app\common\models\Organization $recipient */
...
<table id="allrecords" data-tilda-email="yes" data-tilda-project-id="1308859" data-tilda-page-id="5839398"
    ...
    <tr>
        <td style="background-color: #efefef; "><!--record_mail-->
            <table id="rec104339805" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="619">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin104339805" class="r" style="margin: 0 auto;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
            ...
            <table id="rec104339807" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="322">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin104339807" class="r"
                            ...
                            <tr>
                                <td style="padding-top:15px;padding-bottom:15px;padding-left:30px;padding-right:30px;">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="width:100%;">
                                        <tr>
                                            <td style="width:100%; text-align: center;"><a href="https://banket-b.ru/"
                                                                                           target="_blank"> <img
                                                            width="540" align="center"
                                                            style="width: 100%; height: auto;"
                                                            src="https://banket-b.ru/img/mail-header.png"
                                                            imgfield="img"> </a></td>
                                        </tr>
                                    </table>
                                </td>
            ...
            <table id="rec104339808" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                ...
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        ...
                        <div style="margin-right: auto; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; color:#444444;font-size:20px;line-height:1.45;">
                            ...
                            <table id="rec104492982"
                                   style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                    С уважением, команда Банкет Батл.
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
            ...
            <table id="rec104339810" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                ...
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin104339810" class="r"
                               style="margin: 0 auto;background-color:#ffffff;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
                                <td style="padding-top:0px;padding-bottom:0px;padding-left:30px;padding-right:30px;">
                                    <table valign="top" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td style="height:1px; background-color:#e8e8e8;" height="1px"></td>
                                        </tr>
                                        <tr>
                                            <td style="height:15px;" height="15px"></td>
                                        </tr>
            ...
            <table id="rec104339811" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="617">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin104339811" class="r"
                               style="margin: 0 auto;background-color:#ffffff;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
                                        ...
                                        <tr>
                                            <td style="text-align: center; padding: 0 0 0;">
                                                <div style="margin: 0 auto; font-weight: normal; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; color:#8c8c8c;max-width:350px;">
                                                    ...
                                                    помочь:<a href="https://t.me/joinchat/AAAAAFEGq3pxlnSI9-JvUQ">Telegram</a><br/>support@banket-b.ru<br/><br/>
            ...
            <table id="rec104339812" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="619">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin104339812" class="r" style="margin: 0 auto;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
                                <td style="padding-top:0px;padding-bottom:0px;padding-left:0;padding-right:0;">
                                    <table valign="top" border="0" cellpadding="0" cellspacing="0" width="100%">
